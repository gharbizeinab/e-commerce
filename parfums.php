...
// Récupérer l'ID de la catégorie Parfums
$sql = "SELECT id FROM categories WHERE name = 'Parfums' LIMIT 1";
$result = executeQuery($sql);
$parfums_category = mysqli_fetch_assoc($result);
$category_id = $parfums_category ? $parfums_category['id'] : 2;

// Récupérer tous les produits parfums
